...
import { EditOrderItemData } from "@/modules/orders/dtos/edit-order.dto";
import { Minus, Plus, ShoppingCart, Trash2 } from "lucide-react";
import { useMemo } from "react";

type Props = {
  value: EditOrderItemData[];
  onChange: (values: EditOrderItemData[]) => void;
};

export function EditOrderSummarySection({ value, onChange }: Props) {
