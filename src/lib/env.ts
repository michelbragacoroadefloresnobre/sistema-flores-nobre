...
export const env = createEnv({
  server: {
    ...
    AWS_S3_CLOUDFRONT_URL: z.string().min(1),
    ...
    HELENA_PAGAMENTO_CONFIRMADO_TEMPLATE_ID: z.string().min(1),
    HELENA_PEDIDO_PRODUCAO_TEMPLATE_ID: z.string().min(1),
    HELENA_PEDIDO_CAMINHO_TEMPLATE_ID: z.string().min(1),
    HELENA_PEDIDO_ENTREGUE_TEMPLATE_ID: z.string().min(1),
